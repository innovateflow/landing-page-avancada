...
const props = defineProps({
  ...
  mensagem: {
    type: String,
    default: 'Olá! Gostaria de saber mais sobre o curso.'
  }
})

const whatsappUrl = computed(() => {
  const mensagemCodificada = encodeURIComponent(props.mensagem)
  return `https://wa.me/${props.telefone}?text=${mensagemCodificada}`
})
</script>